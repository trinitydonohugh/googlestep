...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeAllDayIgnored() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times and the third person is an optional attendee.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void notEnoughRoomWithOptionalAttendee() {
    // Have one person, but make it so that there is not enough room at any point in the day to
    // have the meeting.
    //
    // Events  : |--A-----|   |-----A----|
  ...
  public void noMandatoryAttendees() {
    // Have two people, both optional attendees with gaps so that the gaps are identified 
    // and returned.
    //
    // Events  :       |--A--|   
    //                              |--B--| 
  ...
  @Test
  public void onlyOptionalAttendeesIgnored() {
    // Have two people, both optional attendees with no gaps, so there is no time for
    // a meeting that day.
    //
    // Events  : |-----A-----|   
    //                       |-----B-----| 
  ...
  public void containsIgnored() {
    ...
    MeetingRequest request = new MeetingRequest(Arrays.asList(PERSON_A, PERSON_B, PERSON_C), DURATION_30_MINUTES);
